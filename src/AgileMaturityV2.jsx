...
const questions = [
  // SELF-ORGANIZATION (Andrei)
  {
    ...
    options: [
      ...
      { text: "Self-organize immediately — they swarm, unblock, and only escalate when truly stuck", score: 4 },
    ],
  },
  {
    category: "Self-Organization",
    ...
    options: [
      ...
      { text: "Nobody notices — the team has fully internalized the rhythm", score: 4 },
    ],
  },
  {
    category: "Self-Organization",
  ...
  },
  {
    ...
    options: [
      ...
      { text: "The team treats failure as data — they adjust fast, document learnings, and implement changes immediately", score: 4 },
    ],
  },
  ...
  // DELIVERY PREDICTABILITY (Tom + Andrei)
  {
    ...
    options: [
      ...
      { text: "Consistently above 80% — stakeholders trust their forecasts", score: 4 },
    ],
  },
  {
    category: "Delivery Predictability",
    ...
    options: [
      ...
      { text: "The team confidently negotiates — they protect sprint goals and propose alternatives with clear trade-off analysis", score: 4 },
    ],
  },
  {
    category: "Delivery Predictability",
    ...
    options: [
      { text: "No — planning is based on gut feeling or pressure", score: 1 },
      ...
      { text: "The team actively uses cycle time, throughput, and historical data to forecast and improve — they own their metrics", score: 4 },
    ],
  },
  ...
  // CONFLICT RESOLUTION (Andrei)
  {
    ...
    options: [
      ...
      { text: "They use data, experiments, or timeboxed spikes to settle it — disagreement is productive, not personal", score: 4 },
    ],
  },
  {
    category: "Conflict Resolution",
    ...
    options: [
      ...
      { text: "The team addresses it directly and supportively — they hold each other accountable because they care", score: 4 },
    ],
  },
  {
    category: "Conflict Resolution",
    ...
    options: [
      ...
      { text: "Healthy push-back is normal — the team challenges priorities with data and customer insight", score: 4 },
    ],
  },
  ...
  // STAKEHOLDER COMMUNICATION (Andrei)
  {
    ...
    options: [
      ...
      { text: "Team members have direct, trusted relationships with stakeholders — communication flows naturally both ways", score: 4 },
    ],
  },
  {
    category: "Stakeholder Communication",
    ...
    options: [
      ...
      { text: "The team owns the entire review — they tell the story of value delivered, gather feedback, and adapt", score: 4 },
    ],
  },
  {
    category: "Stakeholder Communication",
    ...
    options: [
      ...
      { text: "Radical transparency — the team proactively communicates risks before anyone has to ask", score: 4 },
    ],
  },
  ...
  },
  {
    ...
    options: [
      { text: "Ceremonies imposed on them — feels like overhead", score: 1 },
      { text: "They participate because they have to", score: 2 },
      { text: "They see value and engage meaningfully most of the time", score: 3 },
      { text: "They designed and continuously evolve their own process — it's theirs, not prescribed", score: 4 },
    ],
  },
  {
    category: "Ownership & Accountability",
    ...
    options: [
      ...
      { text: "The team actively shapes the sprint goal — they understand the why and commit because they own the outcome", score: 4 },
    ],
  },
  ...
  // PSYCHOLOGICAL SAFETY (Andrei)
  {
    ...
    options: [
      ...
      { text: "Absolutely — vulnerability is normal and respected. Asking for help is a sign of strength here", score: 4 },
    ],
  },
  {
    category: "Psychological Safety",
    ...
    options: [
      ...
      { text: "It's tolerated but the person feels bad — there's an unspoken cost", score: 2 },
      { text: "The team is understanding and focuses on fixing the issue", score: 3 },
      { text: "Mistakes are treated as learning — the team asks \"what can we improve in our system\" not \"who did this\"", score: 4 },
    ],
  },
  {
    category: "Psychological Safety",
    ...
    options: [
      { text: "They don't — hierarchy is real even if unspoken", score: 1 },
      ...
      { text: "Seniority doesn't determine who speaks — ideas are evaluated on merit, and everyone's voice carries equal weight", score: 4 },
    ],
  },
  ...
  // TECHNICAL PRACTICES (Tom)
  {
    ...
    options: [
      { text: "Tech debt piles up — there's no time or plan to address it", score: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Active pairing/mobbing, thorough reviews, living documentation — no single point of failure on any area", score: 4 },
    ],
  },
];
...
const categoryInsights = {
  "Self-Organization": {
    high: "Your team operates autonomously. They don't need someone telling them what to do — they figure it out, fast. This is the foundation of real agility.",
    ...
    low: "The team depends heavily on external direction. Without someone guiding daily work, momentum drops. This isn't a failure — it's the most common starting point.",
    ...
    lowAction: "Begin with small, safe decisions the team can own — like choosing which tasks to pick first or how to organize their board. Build the muscle gradually.",
  },
  "Continuous Improvement": {
    high: "This team drives their own evolution. They don't wait for someone to tell them something's broken — they experiment, iterate, and improve continuously.",
  ...
  "Ownership & Accountability": {
    ...
    mid: "Ownership exists but it's uneven — a few people carry the weight while others wait to be told.",
  ...
  "Psychological Safety": {
    ...
    highAction: "Model and reinforce. Safety isn't permanent — it needs active maintenance. Continue creating spaces for honest conversation.",
    midAction: "Identify where safety breaks down — in certain meetings? With certain people? In high-pressure moments? Target those specific contexts.",
    lowAction: "This requires dedicated coaching work, not just process changes. Building safety starts with leadership behavior.",
  },
  "Technical Practices": {
    high: "Quality is built in, not bolted on. The team has strong engineering discipline — automated testing, continuous deployment, minimal tech debt.",
